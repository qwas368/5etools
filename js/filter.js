...
class ModalFilter {
	...
	async pPopulateWrapper ($wrp, opts) {
		...
		const $ovlLoading = $(`<div class="w-100 h-100 flex-vh-center"><i class="dnd-font ve-muted">讀取中...</i></div>`).appendTo($wrp);

		const $iptSearch = opts.$iptSearch || $(`<input class="form-control" type="search" placeholder="搜尋...">`);
